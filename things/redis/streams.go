...
func (es eventStore) ListThingsByChannel(ctx context.Context, token, id string, offset, limit uint64, disconnected bool) (things.Page, error) {
	return es.svc.ListThingsByChannel(ctx, token, id, offset, limit, disconnected)
}
...
func (es eventStore) ListChannelsByThing(ctx context.Context, token, id string, offset, limit uint64, disconnected bool) (things.ChannelsPage, error) {
	return es.svc.ListChannelsByThing(ctx, token, id, offset, limit, disconnected)
}
