...
func listThingsByChannelEndpoint(svc things.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		page, err := svc.ListThingsByChannel(ctx, req.token, req.id, req.offset, req.limit, req.disconnected)
		if err != nil {
			return nil, err
		}
...
func listChannelsByThingEndpoint(svc things.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		page, err := svc.ListChannelsByThing(ctx, req.token, req.id, req.offset, req.limit, req.disconnected)
		if err != nil {
			return nil, err
		}
