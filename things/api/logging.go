...
func (lm *loggingMiddleware) ListThingsByChannel(ctx context.Context, token, id string, offset, limit uint64, disconnected bool) (_ things.Page, err error) {
	defer func(begin time.Time) {
	...
	return lm.svc.ListThingsByChannel(ctx, token, id, offset, limit, disconnected)
}
...
func (lm *loggingMiddleware) ListChannelsByThing(ctx context.Context, token, id string, offset, limit uint64, disconnected bool) (_ things.ChannelsPage, err error) {
	defer func(begin time.Time) {
	...
	return lm.svc.ListChannelsByThing(ctx, token, id, offset, limit, disconnected)
}
