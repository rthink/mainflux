...
type ThingRepository interface {
	...
	// user and connected or disconnected to specified channel.
	RetrieveByChannel(ctx context.Context, owner, channel string, offset, limit uint64, disconnected bool) (Page, error)
